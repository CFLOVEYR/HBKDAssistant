...
public class GuideActivity extends AppCompatActivity {
    ...
    private void initPicture() {
        mPicture_1 = getResources().getDrawable(R.mipmap.pic_01);
        mPicture_2 = getResources().getDrawable(R.mipmap.pic_02);
        mPicture_3 = getResources().getDrawable(R.mipmap.pic_03);
    }
