...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    //#################改动源码#######################
    private int tabSelectedTextColor;                       //tab标签选中后的颜色
    private int tabNormalTextColor;                         //tab标签没有选中的颜色
    private  boolean isHasTtriangle;
    public boolean isHasTtriangle() {
        return isHasTtriangle;
    }
    //设置是否有三角指示器
    public void setIsHasTtriangle(boolean isHasTtriangle) {
        this.isHasTtriangle = isHasTtriangle;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isHasTtriangle) {
            ...
            float y1 = height - indicatorHeight-5;

            float x2 = x1 - triangleWidth / 2f;
            float y2 = height - indicatorHeight ;

            float x3 = x1 + triangleWidth / 2f;
            float y3 = height - indicatorHeight;
